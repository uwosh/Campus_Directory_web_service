...
def getCurrentSemesterUgradEndDateInternal (self):
    ...
    if remote_addr in [Plone1, CMF2, Kim_Nguyen_Air, Kim_Nguyen_G5, Plone3, '127.0.0.1', ]:
        ...
        try:
            ...
            conn.connect(connstr)
        dbc = conn()
        querystr = "select term_end_dt from ps_term_tbl where institution = 'UWOSH' and acad_career = 'UGRD' and term_begin_dt <= sysdate and term_end_dt >= sysdate"
        try:
