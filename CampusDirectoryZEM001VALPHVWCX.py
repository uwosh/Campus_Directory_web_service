...
def CampusDirectoryZEM001VALPHVWCX (self, phone_extension):
    ...
    if remote_addr in [Randy_Loch, Kim_Nguyen_G5, '127.0.0.1', ]:
        ...
        cursor.execute("""select * from PS_ZEM001VALPHVW where z_tb_line = :arg1""", arg1=phone_extension)
        retlist = []
        for c1, c2, c3, c4 in cursor:
            retlist.append([c1, c2, c3, c4,])
