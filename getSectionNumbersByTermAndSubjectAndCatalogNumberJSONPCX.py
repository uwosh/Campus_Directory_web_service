...
def getSectionNumbersByTermAndSubjectAndCatalogNumberJSONPCX(self, strm, subject, catalog_nbr, callback="?"):
    request = self.REQUEST
    RESPONSE =  request.RESPONSE
    remote_addr = request.REMOTE_ADDR
    if remote_addr in [Kim_Nguyen_iMac, '127.0.0.1', Plone3, ws_it_uwosh_edu, Kim_Nguyen_MacBook, Kim_Nguyen_MacBook_IDEA_Lab, Kim_Nguyen_G5, John_Hren_MBP, John_Hren_MBP_IDEA_lab]:
...
""",
                       arg1 = strm, arg2 = subject, arg3 = catalog_nbr)
        retlist = []
